...
paramsList = {'start_time_list': [ "2022-2-2", "2022-3-2", "2022-4-2" ], 'end_time_list': [ "2022-3-1", "2022-4-1", "2022-5-1"], 'weights': [2, 10], 'types': ["劳动合同", "各种补贴"], 'name_column': '来访人', 'time_column': '来访时间', 'num_column': '人数', 'purpose_column': '信访目的'}
code_str = """
